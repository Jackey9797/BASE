...
# python main.py --conf ECL-PatchTST --noise_rate 0.5 --idx -1 --device "cuda:1" --aligner 1 --loss huber --refiner 1 --enhance 1 --pred_len 720 --train 0 --theta 1.5 --data_name exchange_rate  --batch_size 64 --summary 1 
